...
const WriteWordExercise = ({ word, onComplete, onMistake, colorPair }) => {
    ...
    const dynamicStyles = StyleSheet.create({
        ...
        questionText: {
            color: darkModeEnabled ? colorPair.text : colorPair.background,
        },
        input: {
            borderColor: darkModeEnabled ? colorPair.background : colorPair.background,
            color: colorPair.background,
        },
        submitButton: {
            backgroundColor: darkModeEnabled ? colorPair.text : colorPair.background,
            opacity: buttonOpacity,
        },
        submitButtonText: {
            color: darkModeEnabled ? colorPair.background : colorPair.text,
        },
        errorText: {
